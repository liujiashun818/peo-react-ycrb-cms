package cn.people.one.modules.file.model;
...
public class MediaInfo extends BaseEntity {
    ...
    public String getFileUrl() {
        return FileFormateUtil.formatFileSrcToWeb(fileUrl);
    }

    public String getLdUrl() {
        return FileFormateUtil.formatFileSrcToWeb(ldUrl);
    }

    public String getSdUrl() {
        return FileFormateUtil.formatFileSrcToWeb(sdUrl);
    }

    public String getHdUrl() {
        return FileFormateUtil.formatFileSrcToWeb(hdUrl);
    }

    public String getCover() {
        return FileFormateUtil.formatFileSrcToWeb(cover);
    }
}