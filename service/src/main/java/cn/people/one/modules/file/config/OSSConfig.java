package cn.people.one.modules.file.config;
...
//      CloudAccount account = new CloudAccount("LTAINeFRLXjTKSlo", "Ubmt44uMcPGfjsYAx6PFfeWoVdo8dh", "http://1235141528253834.mns.cn-beijing.aliyuncs.com/");
//      MNSClient client = account.getMNSClient();
//      CloudQueue queue = client.getQueueRef("medias");
