...
import styles from './imgUploader.less';
...
class ImgUploader extends React.Component {
    ...
    render() {
        ...
        const {width, height, ratio,previewFlag=false} = this.props;
        ...
        return (
            <div className="clearfix">
                <Upload
                    ...
                    accept="image/*"
                    multiple={this.props.single ? false: true} className="img-uploader"
                >
                    {
                ...
                <Modal
                    ...
                    style={{width: '100%'}}
                >
                    {previewFlag&&(previewImage.substring(previewImage.length-3,previewImage.length)=='gif')?
                        ...
                        <ImgEditor
                            ...
                            imgId={previewIndex}
                            imgUrl={previewImage}
                            imgCancel={this.handleCancel}
                            imgSave={this.imgSave}
                        />
                    }
                </Modal>
            </div>
