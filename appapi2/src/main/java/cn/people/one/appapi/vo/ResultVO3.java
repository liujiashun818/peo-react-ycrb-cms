...
public class ResultVO3<T> {
	...
	public static <T> ResultVO3<T> result(ErrorMessage message) {
        ResultVO3<T> rj = new ResultVO3<T>();
        rj.setCode(message.getCode());
        rj.setMsg(message.getMsg());
        return rj;
    }

    public static <T> ResultVO3<T> result(int code, String message) {
        ResultVO3<T> rj = new ResultVO3<T>();
        rj.setCode(code);
        rj.setMsg(message);
        return rj;
    ...
    public static <T> ResultVO3<T> error(String message) {
        return ResultVO3.result(Result.DEFAULT_CODE_ERROR, message);
    }


    public static <T> ResultVO3<T> success(T item, long count, int size, int page) {
    ...
    public static <T> ResultVO3<T> success(T item) {
    	 ResultVO3<T> rj = new ResultVO3<T>();
         rj.setItem(item);
         return rj;
    }
